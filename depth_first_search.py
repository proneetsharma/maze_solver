...
def depth_first_search(maze_map):
...
if __name__ == '__main__':
    ...
    # CALL THESE  after filling in the necessary implementations
    
    path_map1 = depth_first_search(maze_map_map1)
    write_to_file("./results/dfs_map1.txt", path_map1, maze_map_map1)

    path_map2 = depth_first_search(maze_map_map2)
    write_to_file("./results/dfs_map2.txt", path_map2, maze_map_map2)

    path_map3 = depth_first_search(maze_map_map3)
    write_to_file("./results/dfs_map3.txt", path_map3, maze_map_map3)
